            ...
            <>
              ...
              <DropdownMenu.Root>
                <DropdownMenu.Trigger asChild>
                  <Button variant="ghost" className="w-8 h-8 p-0 hover:bg-transparent">
            ...
            <nav className="flex flex-col space-y-2">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
                  className={`text-sm font-medium transition-colors hover:text-primary px-2 py-1 ${isActive(item.href) ? 'text-primary' : 'text-muted-foreground'
                    }`}
